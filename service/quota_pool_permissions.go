...
func ResolveQuotaPoolCapabilities(role, poolAdminLevel int) QuotaPoolCapabilities {
	...
	case common.RoleRootUser:
		return QuotaPoolCapabilities{CanView: true, CanEdit: true, CanRefill: true, CanManageMembers: true, CanManageV1Admins: true, CanManageV2Admins: true, CanDelete: true}
